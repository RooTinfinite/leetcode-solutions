<h2><a href="https://leetcode.com/problems/power-update-after-k-th-largest-insertion-i">Power Update After K-th Largest Insertion I</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an integer array <code>nums</code> and an integer <code>p</code>.</p>

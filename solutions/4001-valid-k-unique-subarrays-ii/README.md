<h2><a href="https://leetcode.com/problems/valid-k-unique-subarrays-ii">Valid K-Unique Subarrays II</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given an integer array <code>nums</code> of length <code>n</code> and an integer <code>k</code>.</p>

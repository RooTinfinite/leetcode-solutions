...
SELECT 
    driver_id, 
    driver_name,
    ROUND(frst_half_avg::numeric, 2) AS first_half_avg,
    ROUND(sec_half_avg::numeric, 2) AS second_half_avg,
    ROUND((sec_half_avg - frst_half_avg)::numeric, 2) AS efficiency_improvement 
FROM summary

<h2><a href="https://leetcode.com/problems/maximum-team-size-with-overlapping-intervals">Maximum Team Size with Overlapping Intervals</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p data-end="767" data-start="694">You are given two integer arrays <code>startTime</code> and <code>endTime</code> of length <code>n</code>.</p>

<h2><a href="https://leetcode.com/problems/number-of-ways-to-paint-sheets">Number of Ways to Paint Sheets</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given an integer <code>n</code> representing the number of sheets.</p>
